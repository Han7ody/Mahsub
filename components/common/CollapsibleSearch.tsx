    ...
    <div ref={containerRef} className={`relative ${className}`}>
      {!isExpanded ? (
        <button
          ...
          className={`size-10 rounded-2xl border border-slate-100 text-slate-600 bg-white hover:bg-slate-50 flex items-center justify-center transition-all ${buttonClassName}`}
        >
