              ...
              onSubmit={async (e) => {
                ...
                if (USE_BACKEND) {
                  ...
                  try {
                    ...
                    // Store registration data for verify page
                    ...
                    router.push(`/auth/verify?mode=register&via=email&value=${encodeURIComponent(email.trim())}`);
                  } catch (error: any) {
            ...
            >
              ...
              <div className="bg-primary-soft dark:bg-primary/10 p-2 md:p-3 rounded-md border border-slate-100 dark:border-border-dark">
                <p className="text-sm text-primary dark:text-primary leading-relaxed text-center font-medium">
                  سيتم إرسال رمز تحقق إلى بريدك الإلكتروني لإكمال التسجيل
                </p>
              </div>
